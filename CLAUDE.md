...
**最新优化 (2025-01-18)**:
- ✅ 修复搜索篇数分配逻辑：scholarly主力搜索获得70%配额
- ✅ 优化scholarly库429错误处理，参考Paper-god-beta2成功经验
...
**Key Features**:
  - 智能配额分配：scholarly获得70%配额，确保搜索结果数量
  - 优化的429错误处理：参考Paper-god-beta2，简化scholarly调用策略
...
4. 智能配额分配：scholarly主力搜索70%，其他数据源30%
5. 多源并行搜索：scholarly + Semantic Scholar + arXiv
6. 智能去重和相关性排序
7. Results returned with performance metrics

**配额分配示例**:
- 30篇搜索 = scholarly 21篇 + semantic_scholar 5篇 + arxiv 5篇
- 50篇搜索 = scholarly 35篇 + 其他源各7篇
...
### 性能优化原则
- scholarly作为主力搜索源，获得70%搜索配额
- 简化scholarly库调用，避免过度配置（参考Paper-god-beta2）
- 使用1-3秒随机延迟，避免429错误
- 预扩展关键词复用，减少重复LLM调用
- 快速意图预筛选，提升响应速度
...
### 搜索引擎优化
- 智能配额分配：scholarly 70% + 其他源 30%
- 优化的scholarly调用：简化配置，1-3秒随机延迟
- 参考Paper-god-beta2成功经验，避免过度优化
- 支持中英文关键词输入和智能扩展

### 数据源配置
- Google Scholar (scholarly库) - 主力搜索源
